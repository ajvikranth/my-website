        ...
        <div id="project" className="">
          ...
          <div className="lg:flex gap-10 mt-12 mb-20">
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="/p1">
                    <Image className="rounded-t-lg" src={cars} alt="" />
                </a>
                <div class="p-5">
                    <a href="/p1">
                    ...
                    <a href="/p1" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
