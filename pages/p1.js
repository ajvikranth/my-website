...
export default function About() {
  ...
  function handleClick() {
    ...
    const handleSubmit = async e => {
      ...
      try {
        const oci_url=process.env.OCI_URL;
        const res = await fetch(oci_url, {
          method: 'POST',
    ...
    return (
      ...
      My solution was a random forest ML model, optimized using grid search and random search, which achieved a mean R2 score of 0.937,
       explaining 93.7% of the variability in the target variable. I am proud of the highly accurate and reliable model I&apos;ve created,
        ...
        <a href="https://www.kaggle.com/datasets/saisaathvik/used-cars-dataset-from-cardekhocom?select=cardekho_updated.csv" className="inline-flex items-center text-blue-600 hover:underline text-2xl">
        dataset source
